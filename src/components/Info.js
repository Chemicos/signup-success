...
export default function Info() {
    ...
    return (
        <section>
            <article className={`newsletter ${isSubmitted ? 'hide' : ''}`}>
                <div className="newsletter-container">
                    <div className="newsletter-info">
                        <h1>Stay updated!</h1>
                        <p>Join 60,000+ product managers receiving monthly updates on:</p>
                        <ul className="newsletter-list">
                            <li className="icon newsletter-item">Product discovery and building what matters</li>
                            <li className="icon newsletter-item">Measuring to ensure updates are a success</li>
                            <li className="icon newsletter-item">And much more!</li>
                        </ul>
                    </div>
                    ...
                    <div className="newsletter-input">
                        ...
                        <button type="submit" onClick={handleSubmit} className="submit-btn">Subscribe to monthly newsletter</button>
                    </div>
                </div>

                <div className="newsletter-img" dangerouslySetInnerHTML={{__html: svgImg}}></div>
            </article>
            {isSubmitted && <SuccessFb onDismissMessage={handleDismissMessage} />}
        </section>
